...
input_layer_size  = 648;  % 20x20 Input Images of Digits
hidden_layer_size = 700;   % 25 hidden units
num_labels = 1;          % 2 labels, from 1 to 2 
...
Accuracy = zeros(1,10);
for i = 1:10
    pred = predict(Theta1, Theta2, X_cv, Threshold(i));
    Accuracy(1,i) = mean(double(pred == Y_cv ) );
end
